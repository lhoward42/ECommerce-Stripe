...
const CartContextProvider = ({ children }) => {
    ...
    const increase = (product, metadata, metadata2, quantity) => dispatch({type: 'UPDATE', payload: { product: product, metadata: metadata, metadata2: metadata2, quantity: quantity } });
